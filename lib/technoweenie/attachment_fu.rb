  ...
  module AttachmentFu # :nodoc:
    ...
    module ClassMethods
      ...
      unless defined?(::ActiveSupport::Callbacks)
        ...
        #     acts_as_attachment
        #     after_resize do |record|
        #       img = get_image_from_record_somehow
      ...
      def copy_to_temp_file(file, temp_base_name)
        basename = File.basename(temp_base_name)
        extname = File.extname(temp_base_name)
        Tempfile.new([basename,extname], Technoweenie::AttachmentFu.tempfile_path).tap do |tmp|
          tmp.close
    ...
    module InstanceMethods
      ...
      protected
        ...
        def random_tempfile_filename
          "#{rand Time.now.to_i}#{filename ? filename[0,FILENAME_MAX_SIZE] : 'attachment'}"
        end
